// Endpoint reaproveitado do antigo resumo do Dashboard (que foi substituído pela
// nova Home). Ninguém mais consumia /api/dashboard/resumo, então esta função
// serverless passou a servir os indicadores do Painel Geral — evitando criar um
// novo arquivo em /api e estourar o limite de 12 Serverless Functions do plano
// Hobby da Vercel. Se algum dia precisar separar de novo, remova outro endpoint
// não utilizado antes de adicionar um novo arquivo em /api.
